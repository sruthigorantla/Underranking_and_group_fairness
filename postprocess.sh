...
python3 main.py --postprocess german FAIR --k 100 
# python3 main.py --postprocess german CELIS --k 100


## rerank COMPAS ProPublica dataset folds using ALG/FA*IR/CELIS 

# python3 main.py --postprocess compas ALG --k 100 
# python3 main.py --postprocess compas FAIR --k 100 
# python3 main.py --postprocess compas CELIS --k 100
...
# python3 main.py --postprocess german CELIS --k 100 --rev_flag True

## rerank COMPAS ProPublica dataset folds using ALG/CELIS 

# python3 main.py --postprocess compas ALG --k 100 --rev_flag True
# python3 main.py --postprocess compas CELIS --k 100 --rev_flag True
