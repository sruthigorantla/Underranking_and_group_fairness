class DatasetDescription():
    ...
    def __init__(self, result_path, orig_path, protected_attribute, score_attribute, protected_group,
                 header, judgment, alpha=0.1):
        self.__result_path = result_path
        self.__orig_data_path = orig_path
        self.__protected_attribute = protected_attribute
        self.__score_attribute = score_attribute
